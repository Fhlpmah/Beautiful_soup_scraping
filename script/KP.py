...
web_page = requests.get(
    'https://www.basketball-reference.com/players/p/porzikr01/gamelog/2022').text
soup = BeautifulSoup(web_page, 'lxml')

# csv writing tool ( in binary mode so the data wont changed )
file = open('KristapsPorzingod.csv', 'w', encoding='utf-8', newline='')
